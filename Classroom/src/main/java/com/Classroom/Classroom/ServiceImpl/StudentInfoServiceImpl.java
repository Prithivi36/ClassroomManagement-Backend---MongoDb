...
public class StudentInfoServiceImpl implements StudentInfoService {
    ...
    public String registerNewStudent(StudentDto studentData) {
        StudentInfo studentInfo=(modelMapper.map(studentData, StudentInfo.class));
        studentInfo.setAbsentList(new ArrayList<>());
        studentInfo.setOnDutyEntities(new ArrayList<>());
